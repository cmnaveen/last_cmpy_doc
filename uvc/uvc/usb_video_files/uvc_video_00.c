...
{   //write it into a file
        ...
        else
        {
            ...
            while(front->next != NULL)
            {
                ...
                for(k=0 ; k < No_of_packets ; k++)
                {
                    ...
                    if(actual_len == 12){
                        printk("packet No:%d ==> actual_length is-------------:%d\n",k,actual_len);
                       // fflag=1;
                    }
                    else if((actual_len != 12) &&(actual_len != 0))
                    {
                        if(fflag == 1){
                            printk("packet No:%d ==> starting frame offset =%d -->actual_len:%d\n",k,current_pos,actual_len);
                            current_pos = current_pos+12; actual_len = actual_len -12;
                            printk("packet No:%d ==> starting frame offset =%d -->actual_len:%d\n",k,current_pos,actual_len);
                        fflag=0;
                        }
    ...
    printk("kernel thread is stoped\n");
