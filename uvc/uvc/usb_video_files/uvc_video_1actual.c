...
{   //write it into a file
    ...
    fp = filp_open("/home/naveen/sample.mjpg", O_WRONLY | O_CREAT | O_TRUNC, 0666);
    if(fp == NULL)
   ...
   //                 int temp_len=1024;
                    ...
                    if((actual_len != 0) &&(actual_len != 12))
                    {
                       ...
                       /* if(actual_len <= temp_len){
                        ...
                        len = vfs_write(fp, (unsigned char *)(tail->dp_urb->transfer_buffer)+current_pos,actual_len, &fp->f_pos);
                            if (len != actual_len) {
                                printk(KERN_ERR "vfs_write failed\n");
                            }
                            current_pos = current_pos + len;
